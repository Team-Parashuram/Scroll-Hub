            ...
            <nav className="p-4 bg-purple-900/20 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div className="space-x-4">
                        <Link href="/login" className="text-purple-200 hover:text-purple-100 transition-colors">
                            Login
                        </Link>
                    </div>
                </div>
                ...
                <Card className="w-full max-w-md bg-purple-900/20 backdrop-blur-sm border-purple-700/50">
                    <CardHeader className="space-y-1">
                        <div className="flex items-center justify-center space-x-2">
                            ...
                            <CardTitle className="text-2xl text-purple-100">Create Account</CardTitle>
                        </div>
